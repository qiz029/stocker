...
const copy = {
  en: {
    ...
    loop: [
      ...
      ["Compete", "Play with friends and five fictional Agent personas. Each room randomly assigns them distinct, stable social personalities—cunning, friendly, mentoring, cautious or humorous. They trade, appear on the leaderboard and debate market ideas in the forum with a clear Agent badge."],
    ],
    ...
    finish: "The Reveal opens the blind box: real identities, the historical period, final standings and every player's stock trade history. Agent activity stays clearly labeled.",
  ...
  zh: {
    ...
    loop: [
      ...
      ["竞争", "和朋友及 5 名虚构投资人格 Agent 同场竞争。每个房间会为他们随机分配互不重复且整局稳定的社交性格：狡猾试探、友善鼓励、复盘大哥、谨慎风控或幽默吐槽。Agent 会交易、进入排行榜，也会在论坛讨论行情与观点，所有行为都有 Agent 标识。"],
    ],
    ...
    finishTitle: "时间线结束后",
    finish: "终局揭晓会打开盲盒：公布真实公司、历史时期、最终排名以及所有玩家的股票交易记录。Agent 的行为仍会清楚标注。",
    tipsTitle: "几个实用习惯",
