...
const hallCopy = {
  en: {
    ...
    era: "Choose an era", duration: "Game duration", createNow: "Create", creating: "Generating world and news copy — can take a few minutes…",
  ...
  zh: {
    ...
    era: "选择时代", duration: "游戏时长", createNow: "创建", creating: "正在生成平行世界与新闻文案，可能需要几分钟…",
