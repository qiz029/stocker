...
var Universe = struct {
	...
	Instruments: []InstrumentSpec{
		{ID: "X01", Raw: "msft", Sector: "SOFT",
			...
			Dossier: Dossier{Alias: "Northgate Systems", Desc: "桌面软件的垄断者", RealName: "Microsoft",
		...
		{ID: "X02", Raw: "csco", Sector: "NET",
			...
			Dossier: Dossier{Alias: "Vantidge Networks", Desc: "网络设备巨头，泡沫叙事的旗手", RealName: "Cisco Systems",
		...
		{ID: "X03", Raw: "intc", Sector: "CHIP",
			...
			Dossier: Dossier{Alias: "Meridian Semiconductor", Desc: "处理器行业的王者", RealName: "Intel",
		...
		{ID: "X04", Raw: "orcl", Sector: "SOFT",
			...
			Dossier: Dossier{Alias: "Crownfield Data Systems", Desc: "企业数据库军火商", RealName: "Oracle",
		...
		{ID: "X05", Raw: "ibm", Sector: "SOFT",
			...
			Dossier: Dossier{Alias: "Halcyon Computing", Desc: "百年计算公司", RealName: "IBM",
		...
		{ID: "X06", Raw: "aapl", Sector: "HW",
			...
			Dossier: Dossier{Alias: "Solstice Computers", Desc: "特立独行的电脑厂", RealName: "Apple",
		...
		{ID: "X07", Raw: "amzn", Sector: "ECOM",
			...
			Dossier: Dossier{Alias: "Longmoor Retail", Desc: "烧钱换增长的万货商店", RealName: "Amazon",
		...
		{ID: "X08", Raw: "ebay", Sector: "ECOM",
			...
			Dossier: Dossier{Alias: "Fenwick Exchange", Desc: "全民线上拍卖行", RealName: "eBay",
		...
		{ID: "X09", Raw: "amd", Sector: "CHIP",
			ExtraBeta: map[string]float64{"SENT": 0.7, "RATE": -0.3},
			Dossier: Dossier{Alias: "Crestline Semiconductor", Desc: "万年老二的芯片挑战者", RealName: "AMD",
		...
		{ID: "X10", Raw: "qcom", Sector: "CHIP",
			ExtraBeta: map[string]float64{"SENT": 0.9, "RATE": -0.4},
			Dossier: Dossier{Alias: "Wavecrest Communications", Desc: "无线时代的专利收租人", RealName: "Qualcomm",
		...
		{ID: "X11", Raw: "txn", Sector: "CHIP",
			ExtraBeta: map[string]float64{"SENT": 0.5, "RATE": -0.3},
			Dossier: Dossier{Alias: "Dunmore Instruments", Desc: "模拟芯片的隐形冠军", RealName: "Texas Instruments",
				Business: "从计算器到手机基带的模拟与数字信号芯片，客户遍布所有电子产品。",
				Bear:     "下游消费电子景气一凉，订单立刻跟着凉。",
				Bull:     "不押注单一终端，什么电子设备火它都有份。"}},
		{ID: "X12", Raw: "adbe", Sector: "SOFT",
			ExtraBeta: map[string]float64{"SENT": 0.6, "RATE": -0.3},
			Dossier: Dossier{Alias: "Marlow Creative Systems", Desc: "设计师的标配工具箱", RealName: "Adobe",
		...
		{ID: "X13", Raw: "hpq", Sector: "HW",
			...
			Dossier: Dossier{Alias: "Branford Instruments", Desc: "硅谷车库神话的老牌厂", RealName: "Hewlett-Packard",
		...
		{ID: "X14", Raw: "ge", Sector: "OLD",
			...
			Dossier: Dossier{Alias: "Grantham Industries", Desc: "什么都造的工业帝国", RealName: "General Electric",
		...
		{ID: "X15", Raw: "xom", Sector: "OLD",
			...
			Dossier: Dossier{Alias: "Grandhaven Petroleum", Desc: "全球油气巨轮", RealName: "ExxonMobil",
		...
		{ID: "X16", Raw: "wmt", Sector: "OLD",
			...
			Dossier: Dossier{Alias: "Fairhaven Stores", Desc: "乡镇起家的零售之王", RealName: "Walmart",
		...
		{ID: "X17", Raw: "", Sector: "TELCO",
			...
			Dossier: Dossier{Alias: "Aldergate Communications", Desc: "并购成瘾的长途电话帝国", RealName: "WorldCom（重建）",
		...
		{ID: "X18", Raw: "", Sector: "NET",
			...
			Dossier: Dossier{Alias: "Kestrel Telecom Equipment", Desc: "百年实验室拆出的设备商", RealName: "Lucent（重建）",
		...
		{ID: "X19", Raw: "", Sector: "NET",
			...
			Dossier: Dossier{Alias: "Skyline Optical Networks", Desc: "北方来的光网络之王", RealName: "Nortel（重建）",
		...
		{ID: "X20", Raw: "", Sector: "TELCO",
			...
			Dossier: Dossier{Alias: "Deepcurrent Networks", Desc: "海底光缆狂想家", RealName: "Global Crossing（重建）",
		...
		{ID: "X21", Raw: "ndx", Sector: "",
			...
			Dossier: Dossier{Alias: "Momentum 100 Index Fund", Desc: "科技百强指数基金", RealName: "NASDAQ-100 指数",
		...
		{ID: "X22", Raw: "spx", Sector: "",
			...
			Dossier: Dossier{Alias: "Capital 500 Index", Desc: "全市场指数基金", RealName: "S&P 500 指数",
