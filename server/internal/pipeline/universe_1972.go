...
var nifty1972Universe = ScenarioUniverse{
	...
	Instruments: []InstrumentSpec{
		...
		{ID: "N02", Raw: "mcd", Sector: "NIFT",
			...
			Dossier: Dossier{Alias: "金拱门快餐", Desc: "高速展店的快餐新贵", RealName: "McDonald's",
		...
		{ID: "N03", Raw: "dis", Sector: "NIFT",
			...
			Dossier: Dossier{Alias: "梦幻影业", Desc: "刚开完新乐园的娱乐帝国", RealName: "Disney",
		...
		{ID: "N04", Raw: "jnj", Sector: "NIFT",
			...
			Dossier: Dossier{Alias: "康婴健护", Desc: "永远增长的健康帝国", RealName: "Johnson & Johnson",
		...
		{ID: "N06", Raw: "ibm", Sector: "OFFC",
			...
			Dossier: Dossier{Alias: "蓝色巨人", Desc: "大型计算机的代名词", RealName: "IBM",
		...
		{ID: "N07", Raw: "xrx", Sector: "OFFC",
			ExtraBeta: map[string]float64{"SENT": 0.35, "RATE": -0.3},
			Dossier: Dossier{Alias: "复印王", Desc: "办公室复印机的代名词", RealName: "Xerox",
		...
		{ID: "N08", Raw: "", Sector: "NIFT",
			...
			Dossier: Dossier{Alias: "胶卷黄", Desc: "感光胶卷与相机霸主", RealName: "Eastman Kodak（重建）",
		...
		{ID: "N09", Raw: "", Sector: "NIFT",
			...
			Dossier: Dossier{Alias: "即影即有", Desc: "即时成像相机的发明者", RealName: "Polaroid（重建）",
		...
		{ID: "N10", Raw: "", Sector: "NIFT",
			...
			Dossier: Dossier{Alias: "铃响美妆", Desc: "上门直销的化妆品帝国", RealName: "Avon（重建）",
